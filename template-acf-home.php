...
<div class="pt-6 pb-6 z-depth-3">
    <div class="row">
    <div class="image-box-1 col-12 col-lg-6" style="background-image: url('<?php the_field('purple_img'); ?>'); background-repeat: no-repeat; background-position: center; background-size: cover;">
